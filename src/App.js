...
function App() {
  const [city, selectcity] = useState(0);
  ...
  return (
    <div className="App">
      ...
      <div className="topComponent">
        ...
        <div className="search" id={!searchActive ? "mobile" : ""}>

          <select onChange={handleSelect} name="il" id="il">
          ...
          <div className="searchIcon" onClick={() => setSearchActive(!searchActive)}>
        ...
        <div className="userPanel" onClick={() => setMenuActive(!menuActive)}>
          <svg className="menuButton" width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="tabs">
            <Tab defaultTab={0} a={setactivetab}>
              <Tab.Panel class="type">
                ...
                <span> İnternet Cafe</span></Tab.Panel>
              <Tab.Panel class="type">
                ...
                <span>Playstation Cafe</span></Tab.Panel>
              <Tab.Panel class="type">
                <svg width="20" className="fillsvg" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span> Simülasyon Cafe</span></Tab.Panel>

              <Tab.Panel class="type">
                <svg className="fillsvg" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span>VR Cafe</span></Tab.Panel>
            </Tab>
          </div>
          <div className="cafes">
            {Cafes.map((cafe, index) => (cafe.type == activetab &&
              <Cafe key={index}
